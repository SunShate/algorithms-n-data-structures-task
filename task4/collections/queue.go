...
func (mt *QueueNode) Index() (i int) { return }
func (mt *QueueNode) SetIndex(_ int) {}

// func (mt *QueueNode) GetStation() int { return mt.Station }
// func (mt *QueueNode) GetTime() int    { return mt.Time }

func (mt *QueueNode) Priority(other interface{}) bool {
	if t, ok := other.(*QueueNode); ok {
		return mt.Time > t.Time
	}
